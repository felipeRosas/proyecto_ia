...
public class Celda extends JComponent implements Constantes {
    ...
    public Celda(int x, int y) {
        ...
        imagenPared = new ImageIcon(getClass().getResource(IMAGEN_PARED)).getImage();
    ...
    public void cambiarTipo(String tipo) {
        ...
        switch (tipo) {
            case TIPO_JUGADOR:
                this.imagenActual = this.imagenJugador;
                break;
            case TIPO_ENEMIGO:
                this.imagenActual = this.imagenEnemigo;
                break;
            case TIPO_VACIO:
                this.imagenActual = this.imagenVacio;
                break;
            case TIPO_PARED:
                this.imagenActual = this.imagenPared;
                break;
        }
    }
